...
- [#9047](https://github.com/thanos-io/thanos/pull/9047): Query-Frontend: Fix vertical sharding splitting classic histogram buckets across shards for `histogram_fraction`, which returned wrong fractions.
