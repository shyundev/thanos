...
- [#9033](https://github.com/thanos-io/thanos/pull/9033): Query: Retry the initial DNS resolution of endpoints and stay not ready until it succeeds, instead of becoming ready with missing endpoints.
